...
public class WorkflowSimplePos09 {
	...
	public static void main(String[] args) {
		...
		Workflow workflow2 = WorkflowFactory.getPredefinedWorkflow("C:\\Users\\cocy\\Desktop\\workspace\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp2\\wtpwebapps\\esla\\WEB-INF",WorkflowFactory.WORKFLOW_POS_SIMPLE_09);
		...
		try {
			...
			String sentence = "회전하는 운동은 같은 구심력을 가지고 미친듯이 돌아간다.";
